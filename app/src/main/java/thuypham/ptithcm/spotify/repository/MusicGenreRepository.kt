...
interface MusicGenreRepository {
    fun getListSongOfMusicGenre(musicGenre: String): ResultData<ArrayList<Song>>
}


class MusicGenreRepositoryImpl : MusicGenreRepository {
    ...
    override fun getListSongOfMusicGenre(musicGenre: String): ResultData<ArrayList<Song>> {
